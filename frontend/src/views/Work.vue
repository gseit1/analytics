<template>
  <div class="page-content work-page">
    ...
    <!-- Filters -->
    <div class="work-filters-row">
      <div class="work-filters-col">
        <div class="card">
          <div class="card-body">
            <div class="work-filters-selects">
              <div>
    ...
    <div class="work-payment-row">
      <div class="card">
        <div class="card-body">
          <h6 class="card-title">Payment Status</h6>
          <div class="work-payment-status">
            <div class="text-center">
