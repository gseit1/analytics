<template>
  <div class="schedule-page">
    ...
    <div class="weekly-money-section mb-4">
      <div class="card">
        <div class="card-header">
          <div class="d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
              <i class="bi bi-cash-coin me-2 text-success"></i>Weekly Earnings Overview
            </h5>
        ...
        <div class="card-body">
          <div class="row g-3">
            <div v-for="(week, index) in weeklyBreakdown" :key="index" class="col-md-6 col-lg-3">
              <div class="week-card">
                <div class="week-header">
                  <strong>Week {{ index + 1 }}</strong>
                  <small class="text-muted">{{ week.dateRange }}</small>
                </div>
                <div class="week-stats">
                  <div class="stat-row">
                    <span class="stat-label">Worked:</span>
                    <span class="stat-value text-success">{{ week.actualHours }}h</span>
                  </div>
                  <div class="stat-row">
                    <span class="stat-label">Scheduled:</span>
                    <span class="stat-value text-info">{{ week.scheduledHours }}h</span>
                  </div>
                  <div class="stat-row">
                    <span class="stat-label">Earnings:</span>
                    <span class="stat-value text-primary fw-bold">${{ week.actualEarnings.toFixed(2) }}</span>
                  </div>
                  <div class="stat-row">
                    <span class="stat-label">Tips:</span>
                    <span class="stat-value text-warning">${{ week.tips.toFixed(2) }}</span>
                  </div>
                  <div class="progress mt-2" style="height: 6px;">
                    <div class="progress-bar bg-success" 
                         :style="{ width: week.completionRate + '%' }"
                         :title="`${week.completionRate}% of scheduled hours completed`">
                    </div>
                  </div>
                </div>
              </div>
